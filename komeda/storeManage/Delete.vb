...
Public Class Delete
    ...
    Private Sub Form8_Load(sender As Object, e As EventArgs) Handles MyBase.Load
        ...
        Button1.BackgroundImage = My.Resources.ResourceManager.GetObject("報廢")
    ...
    Private Sub Button1_Click(sender As Object, e As EventArgs) Handles Button1.Click
        Try
            If String.IsNullOrWhiteSpace(materialnum.Text) Or String.IsNullOrWhiteSpace(amount.Text) Then
            ...
            cmd = conn.CreateCommand()
            cmd.CommandType = CommandType.Text
            cmd.CommandText = "update 庫存 set 存量 = 存量-'" + amount.Text + "' where 食材編號 = '" + materialnum.Text + "'or 食材名稱 = '" + elementName.Text + "'"
            cmd.ExecuteNonQuery()
